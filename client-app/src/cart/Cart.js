...
const Cart = () => {
    ...
    const fetchCart = async () => {
      try {
        ...
        response = await axios.get(
          `${process.env.REACT_APP_HEROKU_URL}/api/auth/${userId}/cart`,
          {
  ...
  const decreaseOneProduct = (productAddId) => async (event) => {
    ...
    const response = await axios.post(
      `${process.env.REACT_APP_HEROKU_URL}/api/product/addToCart`,
      {
  ...
  const removeFromCart = (productRemoveId) => async (event) => {
    event.preventDefault();
    const response = await axios.post(
      `${process.env.REACT_APP_HEROKU_URL}/api/product/removeFromCart`,
      {
              ...
              <TableRow key={item._id}>
                ...
                <TableCell>
                  <img
                    ...
                    src={`${process.env.REACT_APP_HEROKU_URL}/${item.product.imagePath}`}
